                      ...
                      itemBuilder: (context, index) {
                        ...
                        return BlogsTile(
                          ...
                          contactInfo: snapshot.data.docs[index]
                              .data()["contactInfo"],
                          report: snapshot.data.docs[index]
                              .data()["report"],
                ...
                child: Center(
                    ...
                    child:  Column(children: <Widget>[
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Flexible(child:Container(
                              margin: EdgeInsets.only(left: 25, right: 25, top: 5, bottom: 5),
                              child: Text(vehicleNumber, style: TextStyle(fontSize: 18))
                          ),
                          )
                        ],
                      ),
                      ...
                      Row(//ROW 2
                          children: [
                            Container(
                              margin: EdgeInsets.only(left: 25, right: 25, top: 5, bottom: 5),                        child: Icon(
                              Icons.wysiwyg,
                              color: Colors.black87,
                              size: 24.0,
                            ),
                            ...
                            Flexible(child:Container(
                                margin: EdgeInsets.only(left: 25, right: 25, top: 5, bottom: 5),
                                child: Text(registrationNumber, style: TextStyle(fontSize: 18))
                            ),
                            )
                      ...
                      Row(// ROW 3
                          children: [
                            ...
                            Flexible(child:Container(
                                margin: EdgeInsets.only(left: 25, right: 25, top: 5, bottom: 5),
                                child: Text(vehicleType, style: TextStyle(fontSize: 18))
                            ),
                            )
                          ]),
                      Divider(),
                      ...
                      Row(// ROW 3
                          children: [
                            ...
                            Flexible(child:Container(
                                margin: EdgeInsets.only(left: 25, right: 25, top: 5, bottom: 5),
                                child: Text(contactInfo, style: TextStyle(fontSize: 18))
                            ),
                            )
                          ]),
                      Divider(),
      ...
      onTap: () {
        Navigator.push(
            ...
            new MaterialPageRoute(
                ...
                new UpdateScreen(vehicleNumber, registrationNumber, vehicleType, ownerName, contactInfo, report, price, time )));
      },
    );
  }
